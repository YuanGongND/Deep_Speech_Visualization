...
def soundNet( input, numClass = 2, activationUnit = 'relu', l2_reg = 0.01, init = 'lecun_uniform', biasInit = 'Zeros', denseFilterNum = 64 ):
=======
def soundNet( input, numClass = 2, activationUnit = 'relu', l2_reg = 0.01, init = 'Ones' ):
>>>>>>> parent of d3fbead... visualize kernel weight
=======
def soundNet( input, numClass = 2, activationUnit = 'relu', l2_reg = 0.01, init = 'Ones' ):
>>>>>>> parent of d3fbead... visualize kernel weight
...
<<<<<<< HEAD
<<<<<<< HEAD
        input = keras.layers.core.Dense( denseFilterNum, activation = activationUnit, kernel_initializer = init, bias_initializer = biasInit   )( input )
=======
