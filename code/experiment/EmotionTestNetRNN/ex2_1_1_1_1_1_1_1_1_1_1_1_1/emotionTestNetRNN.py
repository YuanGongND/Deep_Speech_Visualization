...
for testFolder in [ 3, 4, 0, 1, 2 ]:
    ...
    # train the model
    resultOnTrain, resultOnTest = expUtil.train( testFeature, testLabel, trainFeature, trainLabel, iteration_num = 25, \
                                                lr_decay = 0.1, batch_size = 32, learningRate = 0.00005, iterationNum = 25, \
