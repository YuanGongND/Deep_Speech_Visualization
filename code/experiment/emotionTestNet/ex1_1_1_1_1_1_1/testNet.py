...
def testNet( input, timeStep_num = 150, convLayer_num_front = 5, filter_num = 32, numClass = 4, init = 'glorot_uniform',\
            activationUnit = 'sigmoid', conv_filter_size_front = 40, pooling_size = 2, convLayer_num_back = 6, conv_filter_size_back = 40, l2_reg = 0.01,\
            denseUnitNum = 64 ):
    ...
    input = keras.layers.pooling.AveragePooling2D( ( 1, pooling_size **(convLayer_num_front - 1) ), padding='same' )( tf.abs( input ) )
