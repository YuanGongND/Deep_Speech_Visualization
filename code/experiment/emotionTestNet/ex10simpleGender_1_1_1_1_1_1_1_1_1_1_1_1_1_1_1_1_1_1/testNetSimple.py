...
def loadInit( shape, dtype = None ):
    ...
    if __name__ == '__main__':
        exterFilterFile = np.loadtxt( '../initializer/bandPassFilters_64_64.csv', delimiter = ',' )
    else:
        exterFilterFile = np.loadtxt( '../../initializer/bandPassFilters_64_64.csv', delimiter = ',' )
...
#%%
def testNet( input, timeStep_num = 150, convLayer_num_front = 1, filter_num = 64, numClass = 4, init = 'he_uniform',\
            activationUnit = 'relu', conv_filter_size_front = 64, pooling_size = 2, convLayer_num_back = 4, conv_filter_size_back = 40, l2_reg = 0.01,\
            denseUnitNum = 64 ):
