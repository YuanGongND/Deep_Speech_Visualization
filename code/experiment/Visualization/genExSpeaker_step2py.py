...
def directAdv( modelName, inputTestFeature, inputTestLabel, eps, iteration_num, norm ):
    ...
    with tf.Session() as sess:
      ...
      for iteration in range( 0, iteration_num ):
          ...
          tempAdvTestFeature = iter_loadtxt( 'genExSpeaker/' + str(eps) + '_' + str(iteration) + 'adv.csv' )
          ...
          tempNoiseTestFeature = iter_loadtxt( 'genExSpeaker/' + str(eps) + '_' + str(iteration) + 'noise.csv' )
...
#        plt.show()
        ...
        np.savetxt( 'genExSpeaker/' + str(norm) + 'RNNoverallAdv1.csv', overallResultAdv, delimiter = ','  )
        np.savetxt( 'genExSpeaker/' + str(norm) + 'RNNoverallNoise1.csv', overallResultNoise, delimiter = ','  )
