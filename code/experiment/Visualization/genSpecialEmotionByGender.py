...
iteration_num = 2
for norm in [ 0 ]:
    folderName = 'gender_conv/fm2'
    #
    testSet = iter_loadtxt( 'emotion_conv/fm5/testSet.csv' )
    ...
    for epsIndex in range( 0, len( epsList ) ):
        resultList1 = directAdv( folderName + '/model_190_.ckpt', testFeature, testLabel, epsList[ epsIndex ], iteration_num, norm )
