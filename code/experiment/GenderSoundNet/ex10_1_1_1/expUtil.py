...
def train( testFeature, testLabel, trainFeature, trainLabel, newFolderName, iteration_num = 100, \
           ...
           modelT = soundNet.soundNet, init = 'lecun_uniform' ):
    ...
    with tf.Session() as sess:
        ...
        prediction = modelT( input_x, numClass = class_num, l2_reg = 0.5, init = init )
...
def loadData( testTask, testFolder = 4, precision = 'original', sampleRate = 16000 ):
    ...
    return trainFeature - 0.5 , trainLabel , testFeature - 0.5, testLabel