...
#    print( tf.get_default_graph().get_name_scope() + str( input.shape ) )
    ...
    with tf.name_scope( 'pool5' ):
        ...
        print( tf.get_default_graph().get_name_scope() + str( input.shape ) )
        pool5Out = tf.multiply( input, 1, name = 'pool5Out' ) 
    ...
    with tf.name_scope( 'conv6' ):
        ...
        input = tf.layers.batch_normalization( input )
        print( tf.get_default_graph().get_name_scope() + str( input.shape ) )
        conv6Out = tf.multiply( input, 1, name = 'conv6Out' ) 
    ...
    with tf.name_scope( 'conv7' ):    
        ...
        input = tf.layers.batch_normalization( input )
        print( tf.get_default_graph().get_name_scope() + str( input.shape ) )
        conv7Out = tf.multiply( input, 1, name = 'conv7Out' ) 
    ...
    with tf.name_scope( 'conv8' ):
        ...
        input = tf.layers.batch_normalization( input )
        print( tf.get_default_graph().get_name_scope() + str( input.shape ) )
        conv8Out = tf.multiply( input, 1, name = 'conv8Out' ) 
    ...
    with tf.name_scope( 'dense1' ):
        ...
        print( tf.get_default_graph().get_name_scope() + str( input.shape ) )
        dense1Out = tf.multiply( input, 1, name = 'dense1Out' ) 
    with tf.name_scope( 'dense2' ):
        ...
        dense2Out = tf.multiply( input, 1, name = 'dense2Out' ) 
