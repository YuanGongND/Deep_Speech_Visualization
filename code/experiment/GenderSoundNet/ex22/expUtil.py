    ...
    with tf.Session() as sess:
        ...
        for iteration in range( 0, iteration_num ):
            ...
            for testBatch in range( 0, testBatchNum ): # 3*32=96 test samples
                ...
                tempTestResult, tempAccuracyTest, outputBeforeDense = sess.run( [ prediction, accuracy, flattenOut ], feed_dict = { input_x: inputTestFeature, input_y: inputTestLabel } ) 
                ...
                #plotTSNE( outputBeforeDense, np.argmax( inputTestLabel, 1 ), newFolderName + '/models/tSNE_' + str( iteration ) + '.png' )
