...
batch_sizeList = [ 16, 24, 36 ]
learningRateList = [ 1e-2, 5e-3, 1e-3, 5e-4, 1e-4, 5e-5, 1e-5 ]
...
for batch_size in batch_sizeList:
    ...
    for learningRate in learningRateList:    
        for init in initList:
            ...
            # train the model
            resultOnTrain, resultOnTest = expUtil.train( testFeature, testLabel, trainFeature, trainLabel, iteration_num = 1, \
